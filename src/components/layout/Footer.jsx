...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/Musembi001', // Updated from your CV
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/Musembi-Joseph1', // Updated from your CV
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Email',
      url: 'mailto:musembijoseph99@gmail.com', // Updated from your CV
      icon: (
  ...
  return (
    <footer className="bg-gray-900 dark:bg-gray-950 text-white mt-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="space-y-4">
            ...
            >
              <span className="bg-gradient-to-r from-blue-500 to-purple-500 text-transparent bg-clip-text">
                Musembi Joseph Makite
              </span>
            </motion.div>
            <p className="text-gray-400 dark:text-gray-300">
              Results-driven Software Developer & ICT Support Specialist.
            </p>
          </div>
        ...
        {/* Copyright */}
        <motion.div 
          className="border-t border-gray-800 mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center text-sm text-gray-400"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          viewport={{ once: true }}
        >
          <p>&copy; {currentYear} Musembi Joseph. All rights reserved.</p>
          <p className="mt-2 sm:mt-0">Built with React & Framer Motion</p>
        </motion.div>
      </div>
    </footer>
  );
